...
### UbuntuLinuxBastion <a name="UbuntuLinuxBastion" id="shady-island.networking.UbuntuLinuxBastion"></a>
...
#### Initializers <a name="Initializers" id="shady-island.networking.UbuntuLinuxBastion.Initializer"></a>

```typescript
import { networking } from 'shady-island'

new networking.UbuntuLinuxBastion(scope: Construct, id: string, props: UbuntuLinuxBastionProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | - The scope in which to define this construct. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.id">id</a></code> | <code>string</code> | - The scoped construct ID. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.props">props</a></code> | <code><a href="#shady-island.networking.UbuntuLinuxBastionProps">UbuntuLinuxBastionProps</a></code> | - Initialization properties for this construct. |

---

##### `scope`<sup>Required</sup> <a name="scope" id="shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.scope"></a>
...
##### `id`<sup>Required</sup> <a name="id" id="shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.id"></a>
...
##### `props`<sup>Required</sup> <a name="props" id="shady-island.networking.UbuntuLinuxBastion.Initializer.parameter.props"></a>

- *Type:* <a href="#shady-island.networking.UbuntuLinuxBastionProps">UbuntuLinuxBastionProps</a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.allowSshAccessFrom">allowSshAccessFrom</a></code> | Allow SSH access from the given peer or peers. |

---

##### `toString` <a name="toString" id="shady-island.networking.UbuntuLinuxBastion.toString"></a>
...
##### `allowSshAccessFrom` <a name="allowSshAccessFrom" id="shady-island.networking.UbuntuLinuxBastion.allowSshAccessFrom"></a>
...
###### `peer`<sup>Required</sup> <a name="peer" id="shady-island.networking.UbuntuLinuxBastion.allowSshAccessFrom.parameter.peer"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### `isConstruct` <a name="isConstruct" id="shady-island.networking.UbuntuLinuxBastion.isConstruct"></a>

```typescript
import { networking } from 'shady-island'

networking.UbuntuLinuxBastion.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="shady-island.networking.UbuntuLinuxBastion.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.property.autoScalingGroup">autoScalingGroup</a></code> | <code>aws-cdk-lib.aws_autoscaling.AutoScalingGroup</code> | The auto-scaling group for this bastion. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.property.connections">connections</a></code> | <code>aws-cdk-lib.aws_ec2.Connections</code> | The network connections associated with this resource. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.property.firewall">firewall</a></code> | <code>shady-island.configuration.IFirewallRules</code> | The instance firewall rules. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastion.property.grantPrincipal">grantPrincipal</a></code> | <code>aws-cdk-lib.aws_iam.IPrincipal</code> | The principal to grant permissions to. |

---

##### `node`<sup>Required</sup> <a name="node" id="shady-island.networking.UbuntuLinuxBastion.property.node"></a>
...
##### `autoScalingGroup`<sup>Required</sup> <a name="autoScalingGroup" id="shady-island.networking.UbuntuLinuxBastion.property.autoScalingGroup"></a>
...
##### `connections`<sup>Required</sup> <a name="connections" id="shady-island.networking.UbuntuLinuxBastion.property.connections"></a>
...
##### `firewall`<sup>Required</sup> <a name="firewall" id="shady-island.networking.UbuntuLinuxBastion.property.firewall"></a>
...
##### `grantPrincipal`<sup>Required</sup> <a name="grantPrincipal" id="shady-island.networking.UbuntuLinuxBastion.property.grantPrincipal"></a>
...
### CustomDomainOptions <a name="CustomDomainOptions" id="shady-island.networking.CustomDomainOptions"></a>

Options for DNS record updates when the instance launches.

#### Initializer <a name="Initializer" id="shady-island.networking.CustomDomainOptions.Initializer"></a>

```typescript
import { networking } from 'shady-island'

const customDomainOptions: networking.CustomDomainOptions = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#shady-island.networking.CustomDomainOptions.property.hostedZone">hostedZone</a></code> | <code>aws-cdk-lib.aws_route53.IHostedZone</code> | The Route 53 hosted zone where the record is upserted. |
| <code><a href="#shady-island.networking.CustomDomainOptions.property.subdomain">subdomain</a></code> | <code>string</code> | The subdomain for the record (e.g. `bastion`, `ssh`, `jump`). |

---

##### `hostedZone`<sup>Required</sup> <a name="hostedZone" id="shady-island.networking.CustomDomainOptions.property.hostedZone"></a>
...
##### `subdomain`<sup>Required</sup> <a name="subdomain" id="shady-island.networking.CustomDomainOptions.property.subdomain"></a>
...
### ElasticFileSystemMount <a name="ElasticFileSystemMount" id="shady-island.networking.ElasticFileSystemMount"></a>

The details for a single EFS mount.

#### Initializer <a name="Initializer" id="shady-island.networking.ElasticFileSystemMount.Initializer"></a>

```typescript
import { networking } from 'shady-island'

const elasticFileSystemMount: networking.ElasticFileSystemMount = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#shady-island.networking.ElasticFileSystemMount.property.directory">directory</a></code> | <code>string</code> | The path where the NFS volume should be mounted. |
| <code><a href="#shady-island.networking.ElasticFileSystemMount.property.fileSystem">fileSystem</a></code> | <code>aws-cdk-lib.aws_efs.IFileSystem</code> | The EFS filesystem to mount. |

---

##### `directory`<sup>Required</sup> <a name="directory" id="shady-island.networking.ElasticFileSystemMount.property.directory"></a>
...
##### `fileSystem`<sup>Required</sup> <a name="fileSystem" id="shady-island.networking.ElasticFileSystemMount.property.fileSystem"></a>
...
### UbuntuLinuxBastionProps <a name="UbuntuLinuxBastionProps" id="shady-island.networking.UbuntuLinuxBastionProps"></a>

Properties for the UbuntuLinuxBastion constructor.

#### Initializer <a name="Initializer" id="shady-island.networking.UbuntuLinuxBastionProps.Initializer"></a>

```typescript
import { networking } from 'shady-island'

const ubuntuLinuxBastionProps: networking.UbuntuLinuxBastionProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.vpc">vpc</a></code> | <code>aws-cdk-lib.aws_ec2.IVpc</code> | The VPC where the bastion will reside. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.aptPackages">aptPackages</a></code> | <code>string[]</code> | An array of APT package names to install. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.aptRepositories">aptRepositories</a></code> | <code>string[]</code> | The names of repositories to enable using apt-add-repository. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.architecture">architecture</a></code> | <code>aws-cdk-lib.aws_ec2.InstanceArchitecture</code> | The CPU architecture for the bastion. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.customDomain">customDomain</a></code> | <code><a href="#shady-island.networking.CustomDomainOptions">CustomDomainOptions</a></code> | The options for creating DNS records upon launch. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.enableIpv6">enableIpv6</a></code> | <code>boolean</code> | Whether to enable IPv6. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.fileSystems">fileSystems</a></code> | <code><a href="#shady-island.networking.ElasticFileSystemMount">ElasticFileSystemMount</a>[]</code> | The Elastic Filesystems to mount. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.installAwsCli">installAwsCli</a></code> | <code>boolean</code> | Whether to install the AWS CLI Snap package. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.instanceType">instanceType</a></code> | <code>aws-cdk-lib.aws_ec2.InstanceType</code> | The instance type for the bastion. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.keyPair">keyPair</a></code> | <code>aws-cdk-lib.aws_ec2.IKeyPair</code> | The key pair to use for this instance. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.role">role</a></code> | <code>aws-cdk-lib.aws_iam.IRole</code> | The instance role (the trust policy must permit ec2.amazonaws.com). |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.secrets">secrets</a></code> | <code>{[ key: string ]: aws-cdk-lib.aws_secretsmanager.ISecret}</code> | The secrets containing database credentials. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.securityGroup">securityGroup</a></code> | <code>aws-cdk-lib.aws_ec2.ISecurityGroup</code> | The security group to attach to the bastion instance. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.ubuntuVersion">ubuntuVersion</a></code> | <code>string</code> | The version of Ubuntu to use. |
| <code><a href="#shady-island.networking.UbuntuLinuxBastionProps.property.volumeSize">volumeSize</a></code> | <code>number</code> | The size in gibibytes (GiB) of the primary disk volume. |

---

##### `vpc`<sup>Required</sup> <a name="vpc" id="shady-island.networking.UbuntuLinuxBastionProps.property.vpc"></a>
...
##### `aptPackages`<sup>Optional</sup> <a name="aptPackages" id="shady-island.networking.UbuntuLinuxBastionProps.property.aptPackages"></a>
...
##### `aptRepositories`<sup>Optional</sup> <a name="aptRepositories" id="shady-island.networking.UbuntuLinuxBastionProps.property.aptRepositories"></a>
...
##### `architecture`<sup>Optional</sup> <a name="architecture" id="shady-island.networking.UbuntuLinuxBastionProps.property.architecture"></a>
...
##### `customDomain`<sup>Optional</sup> <a name="customDomain" id="shady-island.networking.UbuntuLinuxBastionProps.property.customDomain"></a>

```typescript
public readonly customDomain: CustomDomainOptions;
```

- *Type:* <a href="#shady-island.networking.CustomDomainOptions">CustomDomainOptions</a>

The options for creating DNS records upon launch.

---

##### `enableIpv6`<sup>Optional</sup> <a name="enableIpv6" id="shady-island.networking.UbuntuLinuxBastionProps.property.enableIpv6"></a>
...
##### `fileSystems`<sup>Optional</sup> <a name="fileSystems" id="shady-island.networking.UbuntuLinuxBastionProps.property.fileSystems"></a>

```typescript
public readonly fileSystems: ElasticFileSystemMount[];
```

- *Type:* <a href="#shady-island.networking.ElasticFileSystemMount">ElasticFileSystemMount</a>[]

The Elastic Filesystems to mount.

---

##### `installAwsCli`<sup>Optional</sup> <a name="installAwsCli" id="shady-island.networking.UbuntuLinuxBastionProps.property.installAwsCli"></a>
...
##### `instanceType`<sup>Optional</sup> <a name="instanceType" id="shady-island.networking.UbuntuLinuxBastionProps.property.instanceType"></a>
...
##### `keyPair`<sup>Optional</sup> <a name="keyPair" id="shady-island.networking.UbuntuLinuxBastionProps.property.keyPair"></a>
...
##### `role`<sup>Optional</sup> <a name="role" id="shady-island.networking.UbuntuLinuxBastionProps.property.role"></a>
...
##### `secrets`<sup>Optional</sup> <a name="secrets" id="shady-island.networking.UbuntuLinuxBastionProps.property.secrets"></a>
...
##### `securityGroup`<sup>Optional</sup> <a name="securityGroup" id="shady-island.networking.UbuntuLinuxBastionProps.property.securityGroup"></a>
...
##### `ubuntuVersion`<sup>Optional</sup> <a name="ubuntuVersion" id="shady-island.networking.UbuntuLinuxBastionProps.property.ubuntuVersion"></a>
...
##### `volumeSize`<sup>Optional</sup> <a name="volumeSize" id="shady-island.networking.UbuntuLinuxBastionProps.property.volumeSize"></a>
